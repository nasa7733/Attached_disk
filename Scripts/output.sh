...
Terraform
Terraform is an open-source cloud agnostic infrastructure as code tool that provides a consistent CLI workflow to manage hundreds of cloud vendor-specific services. 
Terraform codifies cloud APIs into declarative configuration files.
Most Popular cloud providers like GCP|AWS|Azure all provide their own version of Infra-as-code tools:
